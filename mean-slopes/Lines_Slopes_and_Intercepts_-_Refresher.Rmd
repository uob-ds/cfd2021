...
You'll notice that the point `(x = 5, y = 5)` is on this line. A line can be thought of as a collection of infinitely close points. The equation for a line - in this case the line ```y = x``` - tells you which points are on the line. 
...
We can fit a line to this data by using mathematical techniques which find the equation for the line which minimizes the collective vertical distance between the datapoints and the line.
...
In this example, the predicted Overall Quality rating for Clarity rating of  3.6 is 3.64, as this is the y-coordinate for the point on the line where x = 70.
