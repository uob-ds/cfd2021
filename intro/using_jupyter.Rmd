...
To move from one cell to the next, you can scroll down and click on cells, but it is efficient, instead, to press the Shift key, and press Enter (with Shift still held down).  We will write this as Shift-Enter.
